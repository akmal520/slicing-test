import { Button, Card, CardBody, CardFooter, Dialog, DialogBody, Input, Option, Select, Typography } from '@material-tailwind/react';
...
const AddUser = () => {
    ...
    const handleSubmit = (event) => {
        ...
        addUser(dataChange, (data) => {
            handleOpenDialog();
        });
    };
    return (
        <div>
            <Button onClick={handleOpenDialog} color="blue">Add User</Button>
            <Dialog
                size="md"
                open={openDialog}
